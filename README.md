...
위험 상황에서는 Claude AI의 판단을 받아 대응하는 다람쥐.
...
2분 간격 루프 기준 (21,600회/월), 리스크 스코어 55~80 구간에서만 LLM을 호출하는 다람쥐.
...
> 가성비: **Haiku 4** / **GPT-4o Mini** 추천 (월 $1 이하), 판단 품질: **Sonnet 4** 이상 추천하는 다람쥐.
