...
> **⚠️ 이 소프트웨어는 투자 조언이 아니다람쥐.** 본 프로그램 사용으로 발생하는 모든 금전적 손실에 대한 책임은 전적으로 사용자 본인에게 있는 다람쥐. 암호화폐 거래는 원금 손실 위험이 있으며, 과거 수익이 미래 수익을 보장하지 않는 다람쥐. 반드시 감당 가능한 금액만 투자하는 다람쥐.
